...
Routine({
	...
	~wubDrums = {
		...
		Routine({
			...
			Pbind(
				...
				\dur, Pseq([0.125, 0.25, 0.125] * speed, 48),
				\pan, 1,
				\amp, 0.1
			).play;
		}).play;
	...
	Synth(\buzzDust, [\amp, 0.2, \fadeIn, 0.005, \sustain, 1, \fadeOut, 4]); // 10s
	1.wait;
	...
	8.wait;
	~wubMelody.value(\smoothWave, 9, 0.15, 1.5); // 72s
	8.wait;
	~wubDrums.value; // 64s
	8.wait;
	Synth(\twinkle, [\amp, 0.05, \sustain, 28, \fadeOut, 8]); // 28s
	32.wait;

	Synth(\scale, [\freq, 300, \sustain, 1, \end, 15, \amp, 0.1]);
	~wubMelody.value(\doubleSmoothWave, 3, 0.2); // 24s
	8.wait;
	~breakBuf.value(\cutBuf, cbuf, 0.2, [2, 6, 2, 15], [8, 4, 3, 1], 1); // 16s
	8.wait;
	~wubDrums2.value; // 8s
	8.wait;
	...
	16.wait;
	~wubMelody.value(\doubleSmoothWave, 2, 0.2); // 16s
	~wubMelody.value(\smoothWave, 2, 0.15, 1.5); // 16s
	...
	~melody2.value(\doubleStraightWave, 3, 0.1, 0.0125); // 32s
	8.wait;
	~wubMelody.value(\square, 2, 0.05); // 32s
	4.wait;
	~simpleBass.value(28, 0.25); // 56s
	(4.5).wait;
	~simpleSnare.value(5, 0.3, [1,0.25,0.75,1], 1, 1, [3,1,1,4]); // 40s
	(3.5).wait;
	Synth(\twinkle, [\amp, 0.05, \sustain, 8]); // 8s
	Synth(\smoothWave, [\amp, 0.25, \sustain, 9, \imp, 0.03125, \freq, 250]); // 9s
	8.wait;
	~wubMelody.value(\doubleSmoothWave, 4, 0.2); // 32s
	~wubMelody.value(\smoothWave, 3, 0.15, 1.5); // 24s
	~melody4.value(\doubleSmoothWave, 2, 0.15); // 16s
	...
	8.wait;
	~melody3.value(\distantMachine, 1, 0.05); // 16s
	8.wait;
	Synth(\buzzDust, [\amp, 0.1, \fadeIn, 4, \sustain, 6, \fadeOut, 4]); // 10s
	4.wait;
	Synth(\forestNight, [\buf, sbuf, \amp, 0.5]); // 7s
	~breakBuf.value(\cutBufReverb, fbuf, 0.15, [7.5, 20, 5, 25], [6, 6, 3, 1], 1.875); // 30s
	~breakBuf.value(\cutBuf, fbuf, 0.25, [7.5, 20, 5, 25], [6, 6, 3, 1], 2); // 32s
	8.wait;
